...
const argv = Yargs.usage('Usage: $0 [options]')
    ...
    .describe('storeClusterExpansionZoom', 'Store the "cluster expansion zoom" as a property for each cluster.')
    .default('storeClusterExpansionZoom', false).boolean('storeClusterExpansionZoom').nargs('storeClusterExpansionZoom', 1)
